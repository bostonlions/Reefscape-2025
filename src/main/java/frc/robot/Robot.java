 ...
 * the {@link TimedRobot} documentation. If you change the name of this class or the package after
 * creating this project, you must also update the {@link Main}.java file in the project.
 */
public final class Robot extends TimedRobot {
    ...
    */
    ...
    public void autonomousInit() {
        m_autonomousCommand = Auton.getInstance().getCommand();
    ...
    public void teleopInit() {
        ...
        // want the autonomous to continue until interrupted by another command, remove this
