...
public final class Constants {
    ...
    public static final class ElevatorConstants {
        ...
        public static final Map<Position, Double> heights = Map.ofEntries(
            ...
            entry(Position.L4, 1.402), //Comp: 1.402 home: 1.41
    ...
    public static final class CoralConstants {
        ...
        public static final double loadSpeed = 1.;
    ...
    public static final class AlgaeConstants {
        public static final double intakeSuction = -.12; // with net it is around -.1
        ...
        public static final double hightReefIntakeSpeed = 20.;

        public static final double lowReefIntakeSpeed = -20.;
        ...
        /** Should be the amount of ROTATIONS it takes to stop */
        public static final double extraBargeUnloadRotations = 40;
